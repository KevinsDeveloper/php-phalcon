    ...
    <div class="page-container">
        ...
        <div class="page-sidebar" id="sidebar">
            ...
            <ul class="nav sidebar-menu">
                ...
                {% if menus %}
                {% for menu in menus %}
                <li class="{% if in_array(urlPath, menu['suburl']) or menu['module'] == urlModule[0] %}active open{% endif %}">
                    ...
                    <ul class="submenu">
                        {% if menu['sub'] %}
                        {% for pmenu in menu['sub'] %}
                            <li class="{% if urlPath == pmenu['url'] %}active{% endif %}"><a href="{{pmenu['url']}}"> <span class="menu-text">{{pmenu['title']}}</span> </a></li>
                        {% endfor %}
                        {% endif%}
                    </ul>
                </li>
